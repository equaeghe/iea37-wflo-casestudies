...
ax.bar(wind_dirs / 360 * 2 * pi, wind_freq, color='b', width=2*pi/16)

# import parameters
rotor_diameter = 130
wind_speed = 9.8
turb_ci, turb_co, rated_ws, rated_pwr, turb_diam = wflocs.getTurbAtrbtYAML('IEA37-wind_turbine.onshore_reference.yaml')
wind_speed /= rated_ws
turb_ci /= rated_ws
turb_co /= rated_ws
